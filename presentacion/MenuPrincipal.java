...
/**
 * Clase de presentación - Interfaz de Usuario (UIX)
...
public class MenuPrincipal {
    ...
    public void ejecutar() {
        ...
        while (!salir) {
            try {
                ...
                Integer opcion = validador.leerOpcionMenu(1, 14); // Aumentado a 14 opciones
                ...
                switch (opcion) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        gestionarTallerRevision();
                        break;
                    case 6:
                        gestionarLavadero();
                        break;
                    case 7:
                        verColaRevisionMecanica();
                        break;
                    case 8:
                        verColaLavadero();
                        break;
                    case 9:
                        ...
                        break;
                    case 10:
                        listarVehiculosQueNecesitanMantenimiento();
                        break;
                    case 11:
                        guardarDatosSistema();
                        break;
                    ...
                    case 14:
                        salir = true;
                        guardarDatosSistema(); // Auto-guardado al salir
    ...
    private void registrarVehiculo() {
        ...
        try {
            ...
            if (tipo == 1) {
                ...
                vehiculo = new AutomovilCamioneta(marca, modelo, anio, color,
                        condicion, id, carroceria, kilometraje);
                ...
                vehiculo = new Motocicleta(marca, modelo, anio, color,
                        condicion, id, tipoMoto, kilometraje);
            }
    ...
    private void gestionarTallerRevision() {
        ...
        try {
            switch (opcion) {
                case 1:
                    agregarVehiculoATaller();
                    break;
                case 2:
                    atenderVehiculoTaller();
                    break;
                case 3:
                    verSiguienteEnTaller();
                    break;
                case 4:
                    return;
            }
    ...
    private void gestionarLavadero() {
        ...
        try {
            switch (opcion) {
                case 1:
                    agregarVehiculoALavadero();
                    break;
                case 2:
                    realizarLavadoBasico();
                    break;
                case 3:
                    realizarDetalladoExhibicion();
                    break;
                case 4:
                    verSiguienteEnLavadero();
                    break;
                case 5:
                    return;
            }
            gestor.autoGuardar(); // Auto-guardado tras cambios
