...
/**
 * JavaBean para Automóviles/Camionetas
 */
public class AutomovilCamioneta extends Vehiculo implements IMantenible, ILavable {
    ...
    // --- MÉTODOS CORREGIDOS PARA PERSISTENCIA ---
    public EstadoMantenimiento getEstadoMantenimientoEnum() {
        return estadoMantenimiento;
    }

    public EstadoLavado getEstadoLavadoEnum() {
        return estadoLavado;
    }
    // --------------------------------------------
    ...
    public void setEstadoLavado(EstadoLavado estadoLavado) {
        this.estadoLavado = estadoLavado;
    }

    // Métodos de IMantenible
    @Override
    ...
    public void realizarMantenimiento() {
        if (esUsado()) {
            this.estadoMantenimiento = EstadoMantenimiento.COMPLETADO;
        }
    }
    ...
    public void realizarLavadoBasico() {
        if (esUsado()) {
            this.estadoLavado = EstadoLavado.LAVADO_BASICO;
        }
    }
    ...
    public void realizarDetalladoExhibicion() {
        if (esUsado()) {
            this.estadoLavado = EstadoLavado.DETALLADO_COMPLETO;
        }
    }
    ...
    public void validar() throws VehiculoInvalidoException {
        ...
        if (tipoCarroceria == null) {
            throw new VehiculoInvalidoException("El tipo de carrocería no puede ser nulo");
        }
        if (esUsado() && (kilometraje == null || kilometraje < 0)) {
            throw new VehiculoInvalidoException("El kilometraje debe ser mayor o igual a 0");
        }
    }
    ...
    public String obtenerInformacionCompleta() {
        ...
        if (tipoCarroceria != null) {
            info.append("Carrocería: ").append(tipoCarroceria.getDescripcion()).append("\n");
        }
