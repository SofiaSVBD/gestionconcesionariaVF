...
public class Motocicleta extends Vehiculo implements IMantenible, ILavable {
    ...
    public void validar() throws VehiculoInvalidoException {
        ...
        if (tipoMotocicleta == null) {
            throw new VehiculoInvalidoException("El tipo de motocicleta no puede ser nulo");
        }
    ...
    public String obtenerInformacionCompleta() {
        ...
        if (tipoMotocicleta != null) {
            info.append("Tipo: ").append(tipoMotocicleta.getDescripcion()).append("\n");
        }
