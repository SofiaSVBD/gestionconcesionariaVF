 ...
 * Demuestra el uso práctico de las clases genéricas Contenedor<T> y Par<K,V>
 */
public class EstadisticasAvanzadas {
     ...
     */
    public static Par<Contenedor<AutomovilCamioneta>, Contenedor<Motocicleta>> 
            agruparPorTipo(List<Vehiculo> vehiculos) {
    ...
    public static String generarReportePorTipo(List<Vehiculo> vehiculos) {
        Par<Contenedor<AutomovilCamioneta>, Contenedor<Motocicleta>> grupos = 
            agruparPorTipo(vehiculos);
    ...
    public static List<Par<String, Integer>> generarEstadisticasGenerales(
            InventarioVehiculos inventario, 
            ColaRevisionMecanica taller,
            ColaLavadero lavadero) {
        ...
        estadisticas.add(new Par<>("Necesitan mantenimiento", 
            inventario.obtenerVehiculosQueNecesitanMantenimiento().size()));
