...
public class ColaLavadero {
    ...
    public void agregarACola(Vehiculo v) throws LavaderoException {
        if (v == null) {
            throw new LavaderoException("El vehículo no puede ser nulo");
        }

        if (!v.esUsado()) {
            throw new LavaderoException("Solo los vehículos USADOS pueden entrar al lavadero");
        }

        if (vehiculosEnCola.contains(v.getIdentificador())) {
            throw new LavaderoException("El vehículo ya está en la cola del lavadero");
        }
    ...
    public Vehiculo realizarLavadoBasico() throws LavaderoException {
        if (colaEspera.isEmpty()) {
            throw new LavaderoException("No hay vehículos en la cola del lavadero");
        }

        Vehiculo vehiculo = colaEspera.peek(); // Ver sin sacar
    ...
    public Vehiculo realizarDetalladoExhibicion() throws LavaderoException {
        ...
        Vehiculo vehiculo = colaEspera.poll(); // Sacar de la cola
    ...
    public int getCantidadEnLavadero() {
