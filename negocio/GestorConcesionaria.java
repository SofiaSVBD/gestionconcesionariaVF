...
public class GestorConcesionaria {
    ...
    public void guardarDatos() throws PersistenciaException {
        ...
        // 2. Guardar Cola Taller (Solo IDs)
        ...
        // 3. Guardar Cola Lavadero (Solo IDs)
    ...
    /**
     * Carga todo el estado del sistema
     */
    public void cargarDatos() throws PersistenciaException, VehiculoInvalidoException, InventarioException, TallerException, LavaderoException {
        // 1. Limpiar memoria actual
        inventario = new InventarioVehiculos();
        taller.limpiarCola();
        lavadero.limpiarCola();

        // 2. Cargar Vehículos al Inventario
    ...
    public InventarioVehiculos getInventario() {
        return inventario;
    }

    public ColaRevisionMecanica getTaller() {
        return taller;
    }

    public ColaLavadero getLavadero() {
        return lavadero;
    }
